...
```{r plot1,fig.width=7, fig.height=6,echo=TRUE,screenshot.force = FALSE}
...
# hist(rnorm(1000))
library(rNGCircos)
rNGCircos(genome=list("Example1"=100,"Example2"=200,"Example3"=300),genomeFillColor = c("red","blue","green"))

```

The filling color for chromosome can also be set automatically by choosing a *RColorBrewer* palette, such as *Blues*
```{r plot3, fig.width=7, fig.height=6,echo=TRUE}
hist(rnorm(1000))
library(rNGCircos)
...
The NG-Circos is originally published at 
