...
R language is much more friendly in data visualization and plot programming than html, so we ported NGCircos to this R package based on the *htmlwidgets* framework.
...
default:
```{r plot1, screenshot.force=FALSE,fig.width=8, fig.height=6}
library(NGCircos)
NGCircos()
```
...
```{r plot2, screenshot.force = FALSE,fig.width=8, fig.height=6}
library(NGCircos)
...
```{r plot3, screenshot.force = FALSE,fig.width=8, fig.height=6}
library(NGCircos)
